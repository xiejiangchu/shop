        ...
        <form class="form-horizontal" action="{{route('admin.role.store')}}" method='post'>
          ...
          <div class="box-body">
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" id="name" name='name' placeholder="字母或者下划线" value="">
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-10">
                <input type="text" value="" class="form-control" id="display_name" name='display_name' placeholder="显示名称">
              </div>
            </div>
            <div class="form-group">
              <label for="description" class="col-sm-2 control-label">描述</label>
               <div class="col-sm-10">
                <textarea class="form-control" rows="3" id='description' name='description'  placeholder="角色描述..."></textarea>
              </div>s
            </div>
